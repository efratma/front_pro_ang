...
@Component({
  ...
  templateUrl: './equation-system-easy.component.html',
  styleUrls: ['./equation-system-easy.component.sass']
})
export class EquationSystemEasyComponent {
  Part = Part;
  equation1: string = '';
  equation2: string = '';
...
showExercises: boolean = false;
  ...
  initializeTest(): void {
    ...
    const requests = Array(10).fill(null).map(() => this.authService.getEasySystemOfEquations());
